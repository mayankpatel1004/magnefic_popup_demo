<div style="max-width:600px; margin: 20px auto;background:#FFF;" class="white-popup-block" id="custom-content">
...
<button class="mfp-close" type="button" title="Close (Esc)" style="background:#FFF;">Close</button></div>